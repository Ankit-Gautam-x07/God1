...
class InitialScreen(QWidget):
      ...
      def __init__(self, parent=None):
            ...
            pixmap = QPixmap(GraphicsDirectoryPath('Mic_on.png.webp'))
      ...
      def toggle_icon(self, event=None):
            ...
            if self.toggled:
                  self.load_icon(GraphicsDirectoryPath('Mic_on.png.webp'), 60, 60)
                  MicButtonInitialed()

            else:
                  self.load_icon(GraphicsDirectoryPath('Mic_off.png.webp'), 60, 60)
                  MicButtonClosed()
...
class CustomTopBar(QWidget):
      ...
      def initUI(self):
            ...
            maximize_icon = QIcon(GraphicsDirectoryPath("Maximize.webp"))
            ...
            close_icon = QIcon(GraphicsDirectoryPath("Close.webp"))
      ...
      def maximizeWindow(self):
            if self.parent().isMaximized():
                  ...
                  self.maximize_button.setIcon(maximize_icon) # type: ignore
            else:
