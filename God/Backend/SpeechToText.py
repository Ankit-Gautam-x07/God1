...
user_agent = "Mozilla/5.0 (Windows NT 10.0; Win64; 64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome /89.0.142 Safari/537.36"
chrome_options.add_argument(f'user-agent={user_agent}')
chrome_options.add_argument("--use-fake-ui-for-media-stream")
chrome_options.add_argument("--use-fake-device-for-media-stream")
chrome_options.add_argument("--headless=new")
# Initialize the Chrome WebDriver using ChromeDriverManger.
try:
    service = Service(ChromeDriverManager().install())
    driver = webdriver.Chrome(service=service, options=chrome_options)
except Exception as e:
    print(f"Error initializing Chrome WebDriver: {e}")
    print("Please ensure Chrome browser is installed on your system.")
    print("For Linux, you can install it with: sudo apt-get install google-chrome-stable")
    print("For other systems, please download and install Chrome from google.com/chrome")
    exit(1)
    ...
    while True:
        try:
            ...
            if Text:
                ...
                if InputLanguage and (InputLanguage.lower() == "en" or InputLanguage.lower().startswith("en")):
