...
from dotenv import dotenv_values # Import dotenv for reading environment variable from a .env file
...
def TTS(Text, func=lambda r=None: True):
    while True:
        try:
            ...
            try:
                # Call the provided function with False to signl the end of TTS
                func(False)
